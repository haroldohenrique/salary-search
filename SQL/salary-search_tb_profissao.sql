...
CREATE TABLE `tb_profissao` (
  `idtb_profissao` int NOT NULL AUTO_INCREMENT,
  `nome_profissao` varchar(50) NOT NULL,
  PRIMARY KEY (`idtb_profissao`)
...
INSERT INTO `tb_profissao` VALUES (1,'Selecione'),(2,'Vidraceiro'),(3,'Carcereiro'),(4,'Programador'),(5,'Escritor'),(6,'Atendente de Caixa');
